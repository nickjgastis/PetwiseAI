...
const demoQueryRouter = require('./routes/demoQuery');
...
app.use((req, res, next) => {
    ...
    res.header('Access-Control-Allow-Headers', 'Content-Type, x-api-key, Authorization, X-Demo-Token');
    res.header('Access-Control-Expose-Headers', 'X-Demo-Token');
...
app.use(cors({
    ...
    allowedHeaders: ['Content-Type', 'x-api-key', 'Authorization', 'X-Demo-Token'],
    exposedHeaders: ['X-Demo-Token']
}));
...
app.use('/api/demo', demoQueryRouter);
    ...
    try {
        ...
        const users = (usersRes.data || []).map(u => {
            ...
            return {
                ...
                has_seen_app_tour: u.has_seen_app_tour,
                ...
                student_grad_year: u.student_grad_year || null,
